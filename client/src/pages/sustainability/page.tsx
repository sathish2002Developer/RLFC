      ...
      <section className="py-10 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16"
            ...
            <p className="text-base text-gray-600 max-w-4xl mx-auto leading-relaxed font-montserrat">
              Refex Life Sciences operates under the Refex Group's ESG Strategy and Sustainability Roadmap. 
              Our comprehensive approach ensures responsible growth across all dimensions.
            </p>
          </div>

          {/* Flowing Cards Layout */}
          <div className="space-y-12 mb-20">
            {/* Environmental Responsibility - Left Flow */}
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16"
                 data-aos="slide-right"
                 data-aos-duration="1000"
                 data-aos-delay="100">
              <div className="w-full lg:w-1/2 order-2 lg:order-1">
                <div className="bg-gradient-to-br from-[#7dc244]/10 to-[#7dc244]/5 rounded-3xl p-8 border border-[#7dc244]/20 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
                  <div className="flex items-start gap-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#7dc244] to-[#6bb83a] rounded-2xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 font-montserrat leading-relaxed mb-6">
                        Reducing carbon emissions, energy use, and waste through innovative green technologies and sustainable practices.
                      </p>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white/50 rounded-xl p-4 border border-[#7dc244]/20">
                          <div className="text-lg font-bold text-[#7dc244] mb-1">Net Zero</div>
                          <div className="text-sm text-gray-600 font-montserrat">Carbon by 2040</div>
                        </div>
                        <div className="bg-white/50 rounded-xl p-4 border border-[#7dc244]/20">
                          <div className="text-lg font-bold text-[#7dc244] mb-1">Green Tech</div>
                          <div className="text-sm text-gray-600 font-montserrat">Innovation Focus</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="w-full lg:w-1/2 order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src="https://readdy.ai/api/search-image?query=Environmental%20sustainability%20in%20pharmaceutical%20manufacturing%2C%20green%20technology%20and%20renewable%20energy%20systems%2C%20solar%20panels%20and%20wind%20turbines%20at%20modern%20facility%2C%20lush%20green%20environment%2C%20eco-friendly%20industrial%20complex%2C%20sustainable%20development%2C%20clean%20technology%20innovation&width=600&height=400&seq=environmental-responsibility&orientation=landscape"
            ...
            {/* Social Equity - Right Flow */}
            <div className="flex flex-col lg:flex-row-reverse items-center gap-8 lg:gap-16"
                 data-aos="slide-left"
                 data-aos-duration="1000"
                 data-aos-delay="200">
              <div className="w-full lg:w-1/2 order-2 lg:order-1">
                <div className="bg-gradient-to-br from-[#2879b6]/10 to-[#2879b6]/5 rounded-3xl p-8 border border-[#2879b6]/20 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
                  <div className="flex items-start gap-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#2879b6] to-[#3a8bc4] rounded-2xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 font-montserrat leading-relaxed mb-6">
                        Promoting healthcare accessibility, education, and community empowerment through inclusive growth initiatives.
                      </p>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white/50 rounded-xl p-4 border border-[#2879b6]/20">
                          <div className="text-lg font-bold text-[#2879b6] mb-1">Healthcare</div>
                          <div className="text-sm text-gray-600 font-montserrat">Access for All</div>
                        </div>
                        <div className="bg-white/50 rounded-xl p-4 border border-[#2879b6]/20">
                          <div className="text-lg font-bold text-[#2879b6] mb-1">Education</div>
                          <div className="text-sm text-gray-600 font-montserrat">Community Growth</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="w-full lg:w-1/2 order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src="https://readdy.ai/api/search-image?query=Social%20equity%20and%20community%20healthcare%20programs%2C%20diverse%20group%20of%20people%20receiving%20medical%20care%2C%20healthcare%20accessibility%20initiatives%2C%20community%20health%20workers%2C%20inclusive%20healthcare%20services%2C%20social%20responsibility%20in%20action%2C%20pharmaceutical%20company%20community%20outreach&width=600&height=400&seq=social-equity&orientation=landscape"
                    alt="Social Equity"
                    className="w-full h-80 object-cover rounded-3xl shadow-2xl"
                  />
            ...
            {/* Governance Excellence - Left Flow */}
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16"
                 data-aos="slide-right"
                 data-aos-duration="1000"
                 data-aos-delay="300">
              <div className="w-full lg:w-1/2 order-2 lg:order-1">
                <div className="bg-gradient-to-br from-[#ee6a31]/10 to-[#ee6a31]/5 rounded-3xl p-8 border border-[#ee6a31]/20 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
                  <div className="flex items-start gap-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#ee6a31] to-[#d55a28] rounded-2xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 font-montserrat leading-relaxed mb-6">
                        Upholding integrity, transparency, and accountability across all operations with robust governance frameworks.
                      </p>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white/50 rounded-xl p-4 border border-[#ee6a31]/20">
                          <div className="text-lg font-bold text-[#ee6a31] mb-1">Zero Harm</div>
                          <div className="text-sm text-gray-600 font-montserrat">All Operations</div>
                        </div>
                        <div className="bg-white/50 rounded-xl p-4 border border-[#ee6a31]/20">
                          <div className="text-lg font-bold text-[#ee6a31] mb-1">100%</div>
                          <div className="text-sm text-gray-600 font-montserrat">Transparency</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="w-full lg:w-1/2 order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src="https://readdy.ai/api/search-image?query=Corporate%20governance%20and%20compliance%20in%20pharmaceutical%20industry%2C%20professional%20boardroom%20meeting%2C%20business%20ethics%20and%20transparency%2C%20regulatory%20compliance%20frameworks%2C%20corporate%20responsibility%2C%20professional%20business%20environment%2C%20governance%20excellence&width=600&height=400&seq=governance-excellence&orientation=landscape"
                    alt="Governance Excellence"
                    className="w-full h-80 object-cover rounded-3xl shadow-2xl"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#ee6a31]/20 to-transparent rounded-3xl"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-3xl p-8 md:p-12"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="w-16 h-16 bg-gradient-to-br from-[#7dc244] to-[#6bb83a] rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <i className="ri-leaf-line text-2xl text-white"></i>
                </div>
                <div className="text-2xl font-bold text-[#7dc244] mb-2">Net Zero</div>
                <div className="text-sm text-gray-600 font-montserrat">Carbon Emissions by 2040</div>
              </div>
              
              <div className="text-center bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="w-16 h-16 bg-gradient-to-br from-[#2879b6] to-[#3a8bc4] rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <i className="ri-drop-line text-2xl text-white"></i>
                </div>
                <div className="text-2xl font-bold text-[#2879b6] mb-2">Water+</div>
                <div className="text-sm text-gray-600 font-montserrat">Positive Operations by 2035</div>
              </div>
              
              <div className="text-center bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="w-16 h-16 bg-gradient-to-br from-[#ee6a31] to-[#d55a28] rounded-2xl flex items-center justify-center mx-4 mb-4">
                  <i className="ri-shield-check-line text-2xl text-white"></i>
                </div>
                <div className="text-2xl font-bold text-[#ee6a31] mb-2">Zero Harm</div>
                <div className="text-sm text-gray-600 font-montserrat">In All Operations</div>
              </div>
              
              <div className="text-center bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="w-16 h-16 bg-gradient-to-br from-[#2879b6] to-[#3a8bc4] rounded-2xl flex items-center justify-center mx-4 mb-4">
                  <i className="ri-recycle-line text-2xl text-white"></i>
                </div>
                <div className="text-2xl font-bold text-[#2879b6] mb-2">100%</div>
                <div className="text-sm text-gray-600 font-montserrat">Waste Circularity Target</div>
              </div>
            </div>
          </div>
        </div>
